          ...
          <div className='row' style={{flexFlow:'column'}}>
                ...
                <div className="token__container">
                    <div className='token__container-section'>
                      ...
                      DOGE-1 DAO is a decentralized reserve currency protocol based on the DOGE-1 OHM token. 
                      Each DOGE-1 OHM token is backed by a basket of assets (e.g. BUSD, BNB, ETH and other chain coins) in the DOGE-1 treasury, 
                      giving it an intrinsic value that it cannot fall below. 
                      DOGE-1 also introduces unique economic and game-theoretic dynamics into the market through staking and bonding.
                      ...
                      <h2 style={{display: 'flex',fontSize: '12px', textAlign: 'justify'}}>
                      Our goal is to build a policy-controlled currency system, in which the behavior of the DOGE-1 OHM token is controlled 
                  ...
                  <div className='row'>
                    <div className="token__container" style={{flexFlow: 'row', width: '350px', marginTop:'-10px'}}>
                        <h2 style={{display: 'flex',fontSize: '35px', fontWeight: '900', textAlign: 'center'}}>
                            GAME
                        </h2>
                        <hr width="3" size="50"/>
                        <h2 style={{fontSize: '25px',fontWeight: '100',textAlign: 'center'}}>
                                THEORY
                        </h2>
                    </div>
                </div>
                ...
                <div className="token__container">
                  ...
                  <div className="token__container">
                    <div className='token__container-section'>
                      <h3 style={{display: 'flex',fontSize: '17px', textAlign: 'justify'}}>How to participate in DOGE-1 OHM?</h3>
                      <h2 style={{display: 'flex',fontSize: '12px', textAlign: 'justify'}}>
                  ...
                  <div className="token__container">
                    <div className='token__container-section'>
                      <h3 style={{display: 'flex',fontSize: '17px', textAlign: 'justify'}}>How can I benefit from DOGE-1 OHM?</h3>
                      <h2 style={{display: 'flex',fontSize: '12px', textAlign: 'justify'}}>
                  ...
                  <div className="token__container">
                    <div className='token__container-section'>
                      <h3 style={{display: 'flex',fontSize: '17px', textAlign: 'justify'}}>Who runs DOGE-1 OHM?</h3>
                      <h2 style={{display: 'flex',fontSize: '12px', textAlign: 'justify'}}>
                      No one. DOGE-1 OHM protocol is DAO-governed. All decisions are formed by community members on the forum and made by token holders through snapshot voting.
                      </h2>
                    </div>
                  </div>
                  <div className='bottom-space-md' />
